...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-light bg-dark font-weight-bold" href="pageone.php">Архив</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light bg-dark" href="pagetwo.php">Pricing</a>
            </li>
            <li class="nav-item">
                <a class="nav-link disabled text-light bg-dark" href="pagethree.php">Disabled</a>
            </li>
