...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <a class="nav-link text-light bg-dark">   </a>
            <a class="btn btn-outline-primary" href="header.php" role="button"> Выйти </a>
            <a class="nav-link text-light bg-dark">   </a>
...
<body style="background-image: url('https://klike.net/uploads/posts/2019-11/1572686505_2.jpg')">
</body>
</html>